...
<head>
    ...
    <title>Delivery Login - Food Bridge</title>
        ...
        <div class="signup-form">
            ...
            <div class="form-body">
                ...
                <form action="" method="post" id="loginForm">
                    ...
                    <button type="submit" name="sign" class="btn-submit">Login</button>
                </form>
                
                <div class="form-footer">
                    <p>Not a member? <a href="deliverysignup.php">Signup</a></p>
                </div>
            </div>
        </div>
    </div>
