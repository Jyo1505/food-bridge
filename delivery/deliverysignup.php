...
if(isset($_POST['sign']))
{
    ...
    $query="insert into delivery_persons(name,email,password,phone,city) values('$username','$email','$pass','$phone','$location')";
...
<head>
    ...
    <title>Delivery Person Registration - Food Bridge</title>
...
<body>
    <div class="signup-container" data-aos="fade-up">
        <div class="signup-form">
            <div class="form-header">
                <h1>FoodBridge</h1>
                <p>Delivery Person Registration</p>
            </div>
            ...
            <div class="form-body">
                <?php if(isset($msg) && $msg == 1) { ?>
                    <div class="alert alert-danger">
                        ...
                        <span>Account already exists. <a href='deliverylogin.php'>Sign in instead</a></span>
                    </div>
                <?php } ?>
                ...
                <form action="" method="post" id="signupForm">
                    ...
                    <div class="form-group">
                        ...
                        <div id="district-error" class="error-message">Please select a city</div>
                    </div>
                    
                    <button type="submit" name="sign" class="btn-submit">Register</button>
                </form>
                
                <div class="form-footer">
                    <p>Already a member? <a href="deliverylogin.php">Sign In</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const cityError = document.getElementById('district-error');
        
        function validateCity() {
            if (citySelect.value === "") {
                cityError.style.display = 'block';
                citySelect.style.borderColor = '#e53e3e';
                return false;
            } else {
