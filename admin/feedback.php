...
<style>
    ...
    @media (max-width: 1100px) {
        nav { left: calc(-1 * var(--sidebar-width)); }
        nav.collapsed { left: 0; width: var(--sidebar-width); }
        .dashboard { left: 0; width: 100%; }
        .dashboard.expanded { left: 0; width: 100%; }
        .dashboard .top .left-section { margin-left: 20px; }
        .dashboard.expanded .top .left-section { margin-left: 20px; }
    }
...
<body>
    <nav id="sidebar">
        ...
        <div class="menu-items">
            <ul class="nav-links">
                <li><a href="admin.php"><i class="uil uil-estate"></i><span class="link-name">Dashboard</span><span class="tooltip">Dashboard</span></a></li>
                <li><a href="analytics.php"><i class="uil uil-chart"></i><span class="link-name">Analytics</span><span class="tooltip">Analytics</span></a></li>
                <li><a href="donate.php"><i class="uil uil-heart"></i><span class="link-name">Donations</span><span class="tooltip">Donations</span></a></li>
                <li><a href="#" class="active"><i class="uil uil-comments"></i><span class="link-name">Feedbacks</span><span class="tooltip">Feedbacks</span></a></li>
                <li><a href="adminprofile.php"><i class="uil uil-user"></i><span class="link-name">Profile</span><span class="tooltip">Profile</span></a></li>
            </ul>

            <ul class="logout-mode">
                <li><a href="../logout.php"><i class="uil uil-signout"></i><span class="link-name">Logout</span><span class="tooltip">Logout</span></a></li>
            </ul>
        </div>
    </nav>
                        ...
                        <tbody>
                            <?php
                                ...
                                if($result && mysqli_num_rows($result)>0){
                                    ...
                                    echo '<tr><td colspan="3"><div class="empty-state"><i class="fas fa-inbox"></i><p>No feedback found</p></div></td></tr>';
                                }
                            ?>
                        </tbody>
                    </table>
